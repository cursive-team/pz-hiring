...
* @returns {any}
*/
export function ni_hiring_client_setup_web(id, num_parties) {
...
*/
export function ni_hiring_server_setup_web(sk_share_0, sk_share_1) {
...
* @returns {any}
*/
export function ni_hiring_server_compute_web(jc_fhe_0, jc_fhe_1) {
...
* @returns {any}
*/
export function ni_hiring_client_dec_share_web(ck, result) {
...
* @returns {boolean}
*/
export function ni_hiring_client_full_dec_web(ck, result, share_0, share_1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('pz_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
