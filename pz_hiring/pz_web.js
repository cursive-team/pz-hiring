...
*/
module.exports.ni_hiring_init_web = function(input_seed) {
...
* @returns {any}
*/
module.exports.ni_hiring_client_setup_web = function(id, num_parties) {
    const ret = wasm.ni_hiring_client_setup_web(id, num_parties);
...
*/
module.exports.ni_hiring_server_setup_web = function(sk_share_0, sk_share_1) {
    wasm.ni_hiring_server_setup_web(addHeapObject(sk_share_0), addHeapObject(sk_share_1));
};
...
* @returns {any}
*/
module.exports.ni_hiring_client_encrypt_web = function(ck, position, commitment, combined, salary) {
...
* @returns {any}
*/
module.exports.ni_hiring_server_compute_web = function(jc_fhe_0, jc_fhe_1) {
    const ret = wasm.ni_hiring_server_compute_web(addHeapObject(jc_fhe_0), addHeapObject(jc_fhe_1));
    return takeObject(ret);
};
...
* @returns {any}
*/
module.exports.ni_hiring_client_dec_share_web = function(ck, result) {
    const ret = wasm.ni_hiring_client_dec_share_web(addHeapObject(ck), addHeapObject(result));
    return takeObject(ret);
};
...
* @returns {boolean}
*/
module.exports.ni_hiring_client_full_dec_web = function(ck, result, share_0, share_1) {
    const ret = wasm.ni_hiring_client_full_dec_web(addHeapObject(ck), addHeapObject(result), addHeapObject(share_0), addHeapObject(share_1));
    return ret !== 0;
};
...
const path = require('path').join(__dirname, 'pz_web_bg.wasm');
